...
![Alt-text: Human Development Trend](./imgs/hdi_trend.png)
...
`r if (knitr::is_html_output()) '![](imgs/cwi_table_2.png)'`
...
<iframe align = "center" width = "1000" height = "800" src="./imgs/county_cwi.html"></iframe>
...
`r if (knitr::is_html_output()) '![](imgs/rank_table_2.png)'`
...
<iframe align = "center" width = "110%" height = "700px" src="./imgs/county_cat.html"></iframe>
