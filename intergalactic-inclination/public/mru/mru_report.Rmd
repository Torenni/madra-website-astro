...
![Alt-text: Net Development Assistance Trend](net_assistance.png)
...
`r if (knitr::is_html_output()) '![](total_aid.png)'`
...
`r if (knitr::is_html_output()) '![](gdp_growth.png)'`
...
![Aid Impact on GDP Growth](model_image.png)
